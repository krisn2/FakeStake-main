    ...
    <footer className="w-full py-12 px-6 bg-black/30 backdrop-blur-lg border-t border-gray-800">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-bold text-white">About Demo Stake</h3>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-400 text-sm mb-4">
            Connect with us and contribute to make Demo Stake even better!
          </p>
      ...
      <div className="text-center pt-6">
        <p className="text-gray-400 text-sm">
          © {new Date().getFullYear()} DemoStake. All rights reserved.
        </p>
      </div>
    </footer>
  );
